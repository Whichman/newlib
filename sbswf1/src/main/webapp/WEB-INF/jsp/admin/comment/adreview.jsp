...
<head>
    ...
    <!-- FooTable -->
    <link href="${ctx}/inspinia/css/plugins/footable/footable.core.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <!-- 用户菜单-->
                   <li>
                        <a href="${ctx}/admin/comment"><i class="fa fa-pie-chart"></i> <span class="nav-label">评论</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                           <li><a href="${ctx}/admin/comment">所有评论</a></li>
                            <li><a href="${ctx}/admin/comment/reply">回复评论</a></li>
                            <li class="active"><a href="${ctx}/admin/comment/adreview">添加评论</a></li>
                        </ul>
                   </li>
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="${ctx}/admin/user/useradd">添加用户</a></li>
        ...
        <div id="page-wrapper" class="gray-bg" style="min-height: 1231px;">
                    ...
                    <div class="col-lg-12">
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"> 添加评论</a></li>
                                        ...
                                        <fieldset class="form-horizontal">
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">评论内容:</label>
                                                ...
                                                <div class=" text-right tooltip-demo">
                                                    <a href="mailbox.html" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Send"><i class="fa fa-reply"></i> 提交</a>
                                                    <a href="mailbox.html" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Discard email"><i class="fa fa-times"></i>撤回</a>
