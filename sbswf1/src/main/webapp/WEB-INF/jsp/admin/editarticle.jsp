...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <form action="${ctx}/article/editSave" method="post" id="myForm">
        <div class="row wrapper page-heading">
             ...
             <input type="hidden" name="id" value="${post.id}">
                    <div id="titlewrap">
						<input type="text" size="30" value="${post.postTitle}" name="postTitle" id="title" autofocus="autofocus">
					</div>
            ...
            <div class="col-lg-3">
            	<div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p class = "p1">状态</p>
                        <p class = "p1">公开度</p>
                        <p class = "p1">发布时间 :<fmt:formatDate pattern="yyyy-MM-dd" value="${post.postDate}" /></p>
                                    ...
                                    <div id="category-all" class="tabs-panel">
										...
										<c:forEach items = "${terms}" var = "t">
											<li id="category-2" class="popular-category">
												<label class="selectit"><input value="${t.id}" type="checkbox" name="post_category[]" id="in-category-2" checked="checked">${t.name}</label>
											</li>
										</c:forEach>
										</ul>
									</div>
