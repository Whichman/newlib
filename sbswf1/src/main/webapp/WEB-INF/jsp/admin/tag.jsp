...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="${ctx}/article/tag">标签</a></li>
                    </ul>
                </li>
                <li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
        	...
        	<form class="form-inline" role="search" action="${ctx}/article/tag"
					method="post">
        		<div class="form-group">
         ...
         <table class="table table-hover table-condensed table-bordered">
			...
			<c:forEach items="${termtaglist}" var="c">
				<tr>
					<td>
						...
						<div onMouseOver="show('${c.id}+1')" onMouseOut="hide('${c.id}+1')">
						 	<div id= "${c.id}+1" style ="visibility: hidden;">
						 		<a href="">编辑</a>|
								<a style = "color:red" href="${ctx}/article/deletetag/${c.id}">删除</a>|
								<a href="">查看</a>
							</div>
						</div>
					</td>
		...
		<nav style="text-align: right;">
			...
			<div id="col-left">
				<div class="col-wrap">
					<div class="form-wrap">
					<h2>添加标签</h2>
					<form method="post" action="${ctx}/article/wtag">
					...
					<div class="form-field term-slug-wrap">
						...
						<p class="submit">
							<input type="submit" name="submit" id="submit" class="button button-primary" value="添加新标签">
						</p>
					</form>
					</div>
				</div>
