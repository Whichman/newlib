...
<body>
	<div class="container-fluid">
		...
		<div class="col-sm-4 col-sm-offset-4">
			<form action="${ctx}/post/updateSave" method="post">
				<input type="hidden" name="id" value="${post.id}">
				<div class="form-group">
					<label for="postName">文章名称</label> <input type="text"
						class="form-control" id="postName" placeholder="文章名称"
						name="postTitle" value="${post.postTitle}">
				</div>
				<div class="form-group">
					<label for="repeatpostPassword">密码</label> <input type="password"
						class="form-control" id="postPassword" placeholder="密码"
						name="postPassword" value="${post.postPassword}">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="postType">文章类型</label> <input type="text"
						...
						name="postType" value="${post.postType}">
				</div>
				<div class="form-group">
